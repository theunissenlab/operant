function switchreadop_choice_bunchstims_auto(obj,event)

global peck dio starttime fs fid_out3 fid_out1 YGO YNOGO AS TimerFeeder Past_inval...
    fid_out2 Stims ProbaGo IndGoStims IndNoGoStims TimerStart TimerStop Trial AP
