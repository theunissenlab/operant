...
global peck dio starttime lasttime fs fid_out1 fid_out2 fid_out3 fid_out4...
    ...
    TimerStop TimerStart Test_Duration Past_inval TodayVoc AP
...
TodayVoc = zeros(8,1);
TodayVoc(1) = input('Do you have songs for your repertoire (Yes: 1, No: 0)?');
TodayVoc(2) = input('Do you have Distance calls for your repertoire (Yes: 1, No: 0)?');
TodayVoc(3) = input('Do you have tet calls for your repertoire (Yes: 1, No: 0)?');
TodayVoc(4) = input('Do you have nest calls for your repertoire (Yes: 1, No: 0)?');
TodayVoc(5) = input('Do you have whines for your repertoire (Yes: 1, No: 0)?');
TodayVoc(6) = input('Do you have thuck calls for your repertoire (Yes: 1, No: 0)?');
TodayVoc(7) = input('Do you have Aggresive calls for your repertoire (Yes: 1, No: 0)?');
...
if Trial <= 3
    ...
    TimerStart = timer;
    TimerStart.Timerfcn = {@operant_bunchstims_Repertoire_nextstart};
