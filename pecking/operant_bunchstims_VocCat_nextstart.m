function operant_bunchstims_VocCat_nextstart(obj, event)
...
[Stims, Stim_list]=LoadStims_VocCat(pwd, Trial, TodayVoc);
...
for ss = (13:20)
    if TodayVoc(ss-10)==1
        Set = Stims.sets(ss);
        N_Stim = 0;
        while N_Stim<Nstims*(1-ProbaGo)/length(TodayVoc)
