function switchreadop_Pocking_bunchstims(obj,event)

global NT Nseq ni peck dio starttime fs fid_out2 fid_out3 fid_out6 YGO...
    YNOGO AS TimerFeeder Past_inval ProbaGo TrackFeederBucket TFB once...
    IndGoStims IndNoGoStims Stims
